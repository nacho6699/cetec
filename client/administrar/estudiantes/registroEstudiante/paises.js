...
Template.registrarEstudiante.onRendered(function(e){
	...
	countryElement.options[0] = new Option('Selecciona Pais de Egreso','-1');
 ...
 Template.registrarEstudiante.events({
     'change #country': function(e){
     	...
     	var stateElement = document.getElementById('departamento');
     	stateElement.length=0;	// Fixed by Julian Woods
		stateElement.options[0] = new Option('Selecionar Departamento de Egreso','');
